...
# ---1) This is creating the controller class where all your methods will live inside
class BlogPostsController < ApplicationController
  def index
    # ---2)This is your index method that will run when you render your inddex route that uses the get route to display all of your content in the BlogPost table.
    @posts = BlogPost.all
  end

  def show
    # ---3)This is your show method that will also use the get route and get passed an id for the specific instance by using params to patch in your id for this specific table instance
  ...
  def create
    # ---5)this is your create method that adds the post route so the content you added to new can actually be craeted inside your table 
  ...
  def update
    @post = BlogPost.find(params[:id])
    # ---7)this is your update method which adds patch to your new method and actually makes the changes within your table 
